declare module "react-phone-number-input/locale/fr" {
  const local: {
    [key: string]: string
  }
...
declare module "react-phone-number-input" {
  ...
  export interface PhoneInputProps {
    ...
    countrySelectComponent?: React.Component<
    ...
    flagComponent?: React.Component<
      { country: string; flagsPath: string; flags: FlagsMap },
      object
    >
    flags?: FlagsMap
    flagsPath?: string
    getInputClassName?: (params: {
      disable?: boolean
      invalid?: boolean
    }) => string
    id?: string | number
